...
\end{equation}
where $\atan$ is the $2$ argument inverse tangent.
...
\subsubsection{Non-dimensionalising the nutrient PDE}
...
\subsubsection{Non-dimensionalising the nodes ODE}
...
\subsubsection{Non-dimensionalising the biomass equation}
...
\subsubsection{Non-dimensional model equations of motion (EOMs)}
