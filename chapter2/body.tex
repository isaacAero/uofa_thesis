...
define the nutrient field as $c_{i,j}^{n} = c(x_i, y_j, t_n)$ and similarly for $b_{i,j}^{n}$,
the biomass. The values  $c_{i,j}^{n}$ precisely satisfy the discretised equations which follow.
Let  $\bar{c}_{i,j}^{n}$ be the solution achieved with finite precison arithmetic 
operations which does not necessarily satisfy the equations, up to some error term,
\begin{equation*}
    \epsilon_{i,j}^n = \bar{c}_{i,j}^{n} - c_{i,j}^{n}.
\end{equation*}
Carrying out the Crank-Nicolson discretisation with the values $c_{i,j}^{n}$, we derive
\begin{equation*}
    \frac{c_{i,j}^{n+1} - c_{i,j}^{n}}{\Delta t} =
    \frac{\lambda_1}{2} \left( \nabla^2 c_{i,j}^{n+1} + \nabla^2 c_{i,j}^{n} \right) -
     \frac{1}{2} b_{i,j}^{n} (c_{i,j}^{n+1} + c_{i,j}^{n}),
\end{equation*}
...
\begin{equation*}
    \begin{split}
        \frac{c_{i,j}^{n+1} - c_{i,j}^{n}}{\Delta t} &=
        \frac{\lambda_1}{2}  \left( \frac{c_{i+1,j}^{n+1} - 2 c_{i,j}^{n+1} + c_{i-1,j}^{n+1} }{h^2} + 
                                    \frac{c_{i,j+1}^{n+1} - 2 c_{i,j}^{n+1} + c_{i,j-1}^{n+1} }{h^2} \right)  \\
                                   & +\frac{\lambda_1}{2} \left( \frac{c_{i+1,j}^{n} - 2 c_{i,j}^{n} + c_{i-1,j}^{n} }{h^2} + 
                                    \frac{c_{i,j+1}^{n} - 2 c_{i,j}^{n} + c_{i,j-1}^{n} }{h^2} \right) \\
                                   &-\frac{1}{2} b_{i,j}^{n} (c_{i,j}^{n+1} + c_{i,j}^{n}).
    \end{split}
\end{equation*}
...
\begin{equation*}
    \begin{split}
        c_{i,j}^{n+1} - c_{i,j}^{n} &=
       \frac{\alpha}{2}  \left( c_{i+1,j}^{n+1} + c_{i-1,j}^{n+1} + 
                       c_{i,j+1}^{n+1} + c_{i,j-1}^{n+1}  \right) - 2 c_{i,j}^{n+1}  \\
                                   & +\frac{\alpha}{2} \left( c_{i+1,j}^{n}+ c_{i-1,j}^{n} + 
                                    c_{i,j+1}^{n} + c_{i,j-1}^{n}  \right) - 2 c_{i,j}^{n} \\
                                   &-\frac{\Delta t}{2} b_{i,j}^{n} (c_{i,j}^{n+1} + c_{i,j}^{n}).
    \end{split}
\end{equation*}
