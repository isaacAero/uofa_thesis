...
\begin{tikzpicture}[every text node part/.style={align=center}, 
    ...
    \node (proNothing) [process, right of=dec1, xshift=3cm] {Proceed};
    ...
    \node (for) [process, left of=dec1, xshift=-3cm] {Loop over ensemble};
    ...
    \draw [arrow] (pro1) -| node[anchor=south]{} (for);
...
\caption{A flow chart of \textbf{CellColonySimulator} software package. }
